...
export default class Movies extends Component {
    ...
    handleRight = () => {
        ...
        }, this.changeMovies) // as setState is not async; we use this syntax, so after setState is called, changeMovies is also called
    }
    handleLeft = () => {
    ...
    handleFavourites = (movie) => { // LOCAL STORAGE
        let oldData = JSON.parse(localStorage.getItem("movies-app") || "[]")
